...
class HexPlaneGenerator(torch.nn.Module):
    ...
    def synthesis(self, ws, ws_noise, c, v, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
        ...
        rendering_stitch = []
        for rendering, rendering_back, m, mouth_plane in zip(rendering_image_front, rendering_image_back, mouths_mask, mouths_plane):
    ...
    def forward(self, z, z_noise, c, v, truncation_psi=1, truncation_cutoff=None, neural_rendering_resolution=None, update_emas=False, cache_backbone=False, use_cached_backbone=False, **synthesis_kwargs):
        ...
        return self.synthesis(ws, ws_noise, c, v, update_emas=update_emas, neural_rendering_resolution=neural_rendering_resolution, cache_backbone=cache_backbone, use_cached_backbone=use_cached_backbone, **synthesis_kwargs)
