...
from training_avatar_texture.triplane_head360 import HexPlaneGenerator
...
def generate_images(
    ...
    if reload_modules:
        ...
        G_new = HexPlaneGenerator(*G.init_args, **G.init_kwargs).eval().requires_grad_(False).to(device)
