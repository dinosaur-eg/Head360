...
class StyleGAN2Loss(Loss):
    ...
    def run_G(self, z, z_noise, c, v, swapping_prob, neural_rendering_resolution, update_emas=False):
        ...
        gen_output = self.G.synthesis(ws, ws_noise, c, v, neural_rendering_resolution=neural_rendering_resolution, update_emas=update_emas)
    ...
    def accumulate_gradients(self, phase, real_imgA, real_imgB, real_c, gen_id, gen_z_noise, gen_c, gen_v, gain, cur_nimg):
        ...
        if phase in ['Gmain', 'Gboth']:
            with torch.autograd.profiler.record_function('Gmain_forward'):
                lamda = 100
                gen_img, _gen_ws, _gen_noise = self.run_G(gen_id, gen_z_noise, gen_c, gen_v, swapping_prob=swapping_prob, neural_rendering_resolution=neural_rendering_resolution)
        ...
        if phase in ['Dmain', 'Dboth']:#TODO
            with torch.autograd.profiler.record_function('Dgen_forward'):
                gen_img, _gen_ws, _gen_noise = self.run_G(gen_id, gen_z_noise, gen_c, gen_v, swapping_prob=swapping_prob, neural_rendering_resolution=neural_rendering_resolution, update_emas=True)
